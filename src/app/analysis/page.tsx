      ...
      <main className="flex-grow container mx-auto px-4 py-6 sm:px-6 lg:px-8 max-w-7xl">
        <div className="w-full">
          <div className="mb-6">
            ...
            <p className="text-sm sm:text-base text-gray-600 mt-1">View your calorie trends, meal history, and get AI-powered insights</p>
          </div>

          {/* Analysis Content */}
          <div className="space-y-6">
            {/* Top Row: Calorie Chart and Chatbot */}
